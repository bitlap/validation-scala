 ...
 */
@nowarn
class SizeValidatorForSeqOps extends ConstraintValidator[Size, SeqOps[_, Seq, _]] {
  private var constraintAnnotation: Size = _

  override def initialize(constraintAnnotation: Size): Unit =
    this.constraintAnnotation = constraintAnnotation

  override def isValid(value: SeqOps[_, Seq, _], context: ConstraintValidatorContext): Boolean = {
